 ...
 * @Description: 
 * @Author: zhuyuanzheng
 * @Date: 2020-06-12 23:40:04
 * @LastEditors: zhuyuanzheng
 * @LastEditTime: 2020-09-09 14:33:53
-->
<template>
  <div>
    <el-form :model="form">
...
<script>
//通过on-change获取file文件  auto-upload设为false 
//通过http-request获取file文件 不能设置auto-upload属性
//file-list 初始展示的图片,后续添加不会增加
