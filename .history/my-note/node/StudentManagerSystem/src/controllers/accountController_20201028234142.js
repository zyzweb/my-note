...
exports.getVcodeImage = (req, res) => {
    ...
    p.color(217, 83, 79);  // First color: background (red, green, blue, alpha)
    p.color(105, 174, 24); // Second color: paint (red, green, blue, alpha)
...
exports.login = (req,res)=>{
    ...
    databasetool.getOne("accountInfo",{username:req.body.username,password:req.body.password},(err,doc)=>{
      console.log('req: 11111111111', req);
        if(doc==null){
            result.status = 2
